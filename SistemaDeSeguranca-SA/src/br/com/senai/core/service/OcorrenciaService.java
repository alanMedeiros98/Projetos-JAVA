...
public class OcorrenciaService {
	...
	public void validarData(Ocorrencia ocorrencia) {
		boolean isDataInvalida = ocorrencia.getData() == null
				|| ocorrencia.getData().isBefore(LocalDate.now()) || ocorrencia.getData().isAfter(LocalDate.now());
		
		if (isDataInvalida) {
			throw new IllegalArgumentException("A data é obrigatória e deve corresponder a data atual");
		}
	}
