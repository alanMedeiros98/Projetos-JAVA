...
import br.com.senai.view.envolvido.ViewConsultaEnvolvido;
import br.com.senai.view.incidente.ViewConsultaIncidente;
import br.com.senai.view.ocorrencia.ViewConsultaOcorrencia;
import br.com.senai.view.usuario.ViewConsultaUsuario;
...
public class ViewPrincipal extends JFrame {
	...
	public ViewPrincipal() {
		...
		JMenuItem mnUsuario = new JMenuItem("Usu\u00E1rio");
		...
		JMenuItem nmiAcessos = new JMenuItem("Logs de Acesso");
		nmiAcessos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewLogsAcesso view = new ViewLogsAcesso();
				view.setVisible(true);
			}
		});
		
		mnAcompanhamento.add(nmiAcessos);
