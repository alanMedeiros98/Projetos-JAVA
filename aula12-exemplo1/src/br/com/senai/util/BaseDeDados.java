...
public class BaseDeDados {
	...
	private final int QTDE_MAX = 100;
	...
	public BaseDeDados() {
		this.pacientes = new Paciente[QTDE_MAX];
	}
	...
	public Paciente buscaPor(int id) {
		...
		throw new IllegalArgumentException("Não foi possivel montar a lista.");
	}
